<template>
  ...
  <svg
    v-else-if="name === 'dots-horizontal'"
    fill="none"
    stroke-linecap="round"
    stroke-linejoin="round"
    stroke-width="2"
    viewBox="0 0 24 24"
    stroke="currentColor"
  ><path d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" /></svg>
  <svg
    v-else-if="name === 'document-add'"
    fill="none"
    stroke-linecap="round"
    stroke-linejoin="round"
    stroke-width="2"
